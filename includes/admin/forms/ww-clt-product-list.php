...
<span class="dashicons dashicons-admin-generic" style="font-size: 32px; margin-right: 10px;"></span>
	...
	if ( isset( $_GET['message'] ) && ! empty( $_GET['message'] ) ) { // check message.
		...
		// showing links for sorting for calling this function must override the function get_views() as made in class file.
